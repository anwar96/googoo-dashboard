    ...
    <div class="col-xs-6">
        <form role="form" action="{{URL::current()}}" method="POST">
            ...
            <div class="form-group @if($errors->has('client_id')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control client" id="client" name="client" value="{{Input::old('client', $audiospots->nama)}}">
                <input type="hidden" class="client_id" name="client_id" value="{{Input::old('client_id', $audiospots->client_id)}}"/>
