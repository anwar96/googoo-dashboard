    ...
    <div class="col-xs-6">
        <form role="form" action="{{URL::current()}}" method="POST">
            <div class="form-group @if($errors->has('nama')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control" id="nama" name="nama" value="{{Input::old('nama')}}">
                @if($errors->has('nama'))
            ...
            <div class="form-group @if($errors->has('instansi')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control" id="instansi" name="instansi" value="{{Input::old('instansi')}}">
            ...
            <div class="form-group @if($errors->has('email')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control" id="email" name="email" value="{{Input::old('email')}}">
                @if($errors->has('email'))
            ...
            <div class="form-group @if($errors->has('telp')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control" id="telp" name="telp" value="{{Input::old('telp')}}">
                @if($errors->has('telp'))
            ...
            <div class="form-group @if($errors->has('alamat')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control" id="alamat" name="alamat" value="{{Input::old('alamat')}}">
