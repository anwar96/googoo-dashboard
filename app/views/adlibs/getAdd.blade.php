    ...
    <div class="col-xs-6">
        <form role="form" action="{{URL::current()}}" method="POST">
            ...
            <div class="form-group @if($errors->has('genre')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control autocomplete" id="genre" name="genre" placeholder="jika typenya event maka genre diisi dengan none" value="{{Input::old('genre')}}">
                @if($errors->has('genre'))
            ...
            <div class="form-group @if($errors->has('count')) has-error  has-feedback @endif">
                ...
                <input type="input" class="form-control" id="count" name="count" value="{{Input::old('count')}}">
                @if($errors->has('count'))
            ...
            <div class="form-group @if($errors->has('type')) has-error  has-feedback @endif">
                ...
                {{ Form::select('type', ["genre" => "genre", "event" => "event"], null, ['class' => 'form-control']) }}
                @if($errors->has('type'))
            ...
            <div class="form-group @if($errors->has('status')) has-error  has-feedback @endif">
                ...
                {{ Form::select('status', ["active" => "active", "nonactive" => "nonactive"], null, ['class' => 'form-control']) }}
